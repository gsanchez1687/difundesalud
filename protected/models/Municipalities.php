 ...
 * @property Parishes[] $parishes
 */
class Municipalities extends CActiveRecordExt
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'events' => array(self::HAS_MANY, 'Events', 'municipality_id'),
			'parishes' => array(self::HAS_MANY, 'Parishes', 'municipality_id'),
		);
	}
	...
	public static function model($className=__CLASS__)
	{
		return parent::model($className);
            ...
            public static function getListMunicipalities($id = NULL) {

                $id = intval($id);
                
        $data = Municipalities::model()->findAll(array(
            'select' => 'id, name',
